...
function developr_comment( $comment, $args, $depth ) {
	...
	<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
		<div class="comment-body">
			<?php _e( 'Pingback:', 'developr' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( __( 'Edit', 'developr' ), '<span class="edit-link">', '</span>' ); ?>
		</div>
		...
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			<footer class="comment-meta">
				...
				<div class="comment-metadata">
					...
					<?php edit_comment_link( __( 'Edit', 'developr' ), '<span class="edit-link">', '</span>' ); ?>
				</div><!-- .comment-metadata -->

				<?php if ( '0' == $comment->comment_approved ) : ?>
				<p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'developr' ); ?></p>
				<?php endif; ?>
			</footer><!-- .comment-meta -->
...
function developr_posted_on() {
	...
	printf( __( '<span class="posted-on"><i class="fa fa-clock-o"></i> %1$s</span><span class="byline"> by %2$s</span>', 'developr' ),
