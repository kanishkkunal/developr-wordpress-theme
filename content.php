...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'developr' ) ); ?>
		<?php
			wp_link_pages( array(
	...
	<footer class="entry-meta">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'developr' ), $categories_list ); ?>
			</span>
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'developr' ), __( '1 Comment', 'developr' ), __( '% Comments', 'developr' ) ); ?></span>
		<?php endif; ?>
